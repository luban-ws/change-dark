...
- 2026-04-19：媒体补偿选择器扩展（`object` / `embed` / `iframe` / `audio` / `[role="img"]` 等），与 Filter+ 共用 `buildFilterInvertMediaSelectorList`；见 [RFC 027](../rejected/027-theme-mode-filter-css-refinement.md) Decision log。
