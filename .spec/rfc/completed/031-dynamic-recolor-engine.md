...
**对照**：Filter/Filter+（[RFC 027](../rejected/027-theme-mode-filter-css-refinement.md) / [RFC 028](../rejected/028-theme-mode-filter-plus-refinement.md)）经核对与 Dark Reader 语义一致，**不在本 RFC 范围**。
