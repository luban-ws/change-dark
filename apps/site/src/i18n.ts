...
const resources = {
  en: {
    translation: {
      ...
      techDesc: 'Optimized for modern browsers with granular per-site control and a Dynamic recolor engine.',
      ...
      featThemeTitle: 'Dynamic Engine',
      featThemeBody: 'Stylesheet and inline recolor with WASM-backed color math; Solarized and dark palettes.',
  ...
  zh: {
    translation: {
      ...
      preview: '界面预览',
      techTitle: '系统特性',
      techDesc: '为现代浏览器深度优化，提供精细的站点控制与 Dynamic 改色引擎。',
      ...
      featThemeTitle: 'Dynamic 引擎',
      featThemeBody: '基于 stylesheet/inline 改色与 WASM 配色；支持 dark 与 Solarized 页面调色板。',
      featWasmTitle: '轻量且迅速',
