...
import type { SamplingBudget } from './sampling-budget'
import { computeDeadlineMs, isPastDeadline } from './sampling-budget'
...
export function applyRecolorMutationFlush(
  ...
  if (plan.rebuildStylesheets) {
    applyRecolorInjection(doc, themeFilters, profile)
